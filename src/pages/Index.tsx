...
const Index = () => {
  ...
  const quickActions = [
    { icon: 'Send', label: 'Перевести', color: 'bg-primary' },
    { icon: 'Download', label: 'Пополнить', color: 'bg-secondary' },
    { icon: 'QrCode', label: 'QR-код', color: 'bg-accent' },
    { icon: 'CreditCard', label: 'Карты', color: 'bg-purple-500' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 pb-24">
      <div className="max-w-md mx-auto p-6 space-y-6">
        ...
        <div className="space-y-4 animate-scale-in">
          <div 
            className="relative h-52 rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:scale-[1.02]"
            ...
            <div className="relative h-full p-6 flex flex-col justify-between text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs opacity-75 mt-1">{activeCard.cardNumber}</p>
                </div>
